...
projects = {
  msvc9 = {
    generator = "vs2008",
    build = [[tmp= temp= cmd /Q /C call "c:/Program Files (x86)/Microsoft Visual Studio 9.0/Common7/Tools/vsvars32.bat" "&&" msbuild Frames.sln /p:configuration=Release /m && msbuild Frames.sln /p:configuration=Debug /m]],
  },
  msvc10 = {
    generator = "vs2010",
